...
public class QueuePage extends TestSetUp{
	...
	By linkLL = By.xpath("//a[text()='Queue']");
	By header = By.xpath("//h4");
	By btnGetStarted = By.xpath("//h5[text()='Queue']/../a[text()='Get Started']");
	...
	public void selectQueue() throws IOException {
