...
public class LinkedList extends TestSetUp{
	...
	public LinkedList() {
		linkedListPage = new LinkedListPage(DriverSetUp.getDriver());
	}
		
	@When("User click on Linked List from the dropdown")
	public void user_click_on_linked_list_from_the_dropdown() throws IOException {
	...
	public void user_click_on_get_started_button_for_linked_list() throws IOException {
